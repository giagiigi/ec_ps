...
public class AuthSSLProtocolSocketFactory implements SecureProtocolSocketFactory {
	 ...
	 */
	public AuthSSLProtocolSocketFactory(final String keystoreUrl,
			final String keystorePassword, final String truststoreUrl,
		...
		try {
		    ...
		    logger.error("Initial SSL Error!");
...
//    {
//        return createKeyStore(url, password, "jks");
//    }

    private static KeyStore createKeyStore(final URL url, final String password, final String type) 
        throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException
    {
        if (url == null) {
    ...
    private SSLContext createSSLContext() {
        try {
            ...
            if (this.keystoreUrl != null) {
                KeyStore keystore = createKeyStore(this.keystoreUrl, this.keystorePassword, "jks");
