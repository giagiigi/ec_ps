...
import jp.co.sint.webshop.web.bean.back.catalog.RelatedCategoryTreeBean;
 ...
 */
public class RelatedCategoryTreeInitAction extends WebBackAction<RelatedCategoryTreeBean> {
  ...
  public WebActionResult callService() {
    ...
    RelatedCategoryTreeBean reqBean = new RelatedCategoryTreeBean();
    ...
    // 商品名の取得
    CommodityHeader commodityHeader = service.getCommodityHeader(reqBean.getShopCode(), reqBean.getCommodityCode());
  ...
  public void prerender() {
    RelatedCategoryTreeBean reqBean = (RelatedCategoryTreeBean) getRequestBean();
