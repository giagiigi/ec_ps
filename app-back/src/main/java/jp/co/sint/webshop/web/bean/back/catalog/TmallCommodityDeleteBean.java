...
/**
 * U1040160:商品削除確認のデータモデルです。
 * 
 * @author System Integrator Corp.
 */
public class TmallCommodityDeleteBean extends UIBackBean {

  /** serial version uid */
  private static final long serialVersionUID = 1L;

  private List<TmallCommodityDeleteListBean> list = new ArrayList<TmallCommodityDeleteListBean>();
  
  private boolean displayDeleteButton = false;

  /**
   * U1040160:商品削除確認のサブモデルです。
   * 
   * @author System Integrator Corp.
   */
  public static class TmallCommodityDeleteListBean implements Serializable {
   ...
   * @return list
   */
  public List<TmallCommodityDeleteListBean> getList() {
    return list;
  }
   ...
   *          list
   */
  public void setList(List<TmallCommodityDeleteListBean> list) {
    this.list = list;
  }
