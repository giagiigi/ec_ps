 ...
 */
public class CommodityListBean extends UIBackBean implements UISearchBean {
  ...
  private List<CommodityListResult> list = new ArrayList<CommodityListResult>();
  ...
  // update by os014 2012-02-14 begin
  // private CodeAttribute[] displaySaleStatusList = SaleStatus.values();
  private List<NameValue> displaySaleStatusList = NameValue.asList(SaleStatus.ON_SALE.getValue() + ":"
      + SaleStatus.ON_SALE.getName() + "/" + SaleStatus.DISCONTINUED.getValue() + ":" + SaleStatus.DISCONTINUED.getName());

  // update by os014 2012-02-14 end
  ...
  private List<NameValue> displayCommodityTypeList = NameValue.asList("0:" + "通常商品" + "/1:" + "礼品" + "/2:" + "宣传品" + "/3:" + "全部商品");

  private List<NameValue> displaySetCommodityFlg = NameValue.asList("0:" + "对象外" + "/1:" + "对象内" + "/2:" + "全部商品");
  ...
  // add by tangweihui 2012-11-16 start
  @Metadata(name = "商品区分")
  private String searchCommodityType = "3";

  @Metadata(name = "套装商品区分")
  private String searchSetcommodityflg = "2";
  ...
  public static class CommodityListResult implements Serializable {
    ...
    //套餐明细有無
    private boolean relatedCompositionFlg = false;
    ...
    /**
     * relatedCompositionを取得します。
     * 
     * @return relatedComposition
     */
	public boolean isRelatedCompositionFlg() {
		return relatedCompositionFlg;
	}

    /**
     * relatedCompositionを設定します。
     * 
     * @param relatedComposition
     *          relatedComposition
     */
	public void setRelatedCompositionFlg(boolean relatedCompositionFlg) {
		this.relatedCompositionFlg = relatedCompositionFlg;
	}

  /**
   * setCommodityFlgを取得します。
   * 
   ...
   * @return list
   */
  public List<CommodityListResult> getList() {
    return list;
  }
   ...
   *          list
   */
  public void setList(List<CommodityListResult> list) {
    this.list = list;
  }
  ...
  public String getModuleName() {
    return Messages.getString("web.bean.back.catalog.CommodityListBean.0");
  }
  ...
  // {
  // this.displaySaleStatusList =
  // ArrayUtil.immutableCopy(displaySaleStatusList);
  // }
  ...
  /**
   * displayCommodityTypeListを取得します。
   * 
   * @return displayCommodityTypeList
   */
  public List<NameValue> getDisplayCommodityTypeList() {
    return displayCommodityTypeList;
  }

  /**
   * displayCommodityTypeListを設定します。
   * 
   * @param displayCommodityTypeList
   *          displayCommodityTypeList
   */
  public void setDisplayCommodityTypeList(List<NameValue> displayCommodityTypeList) {
    this.displayCommodityTypeList = displayCommodityTypeList;
  }

  public List<NameValue> getDisplaySetCommodityFlg() {
    return displaySetCommodityFlg;
  }

  public void setDisplaySetCommodityFlg(List<NameValue> displaySetCommodityFlg) {
    this.displaySetCommodityFlg = displaySetCommodityFlg;
  }

  /**
   * @return the displaySaleStatusList
   */
  public List<NameValue> getDisplaySaleStatusList() {
    return displaySaleStatusList;
  }
  ...
  /**
   * @param displaySaleStatusList
   *          the displaySaleStatusList to set
   */
  public void setDisplaySaleStatusList(List<NameValue> displaySaleStatusList) {
    this.displaySaleStatusList = displaySaleStatusList;
  }
