 ...
 */
public class TmallCommodityDeleteDeleteAction extends WebBackAction<TmallCommodityDeleteBean> {
  ...
  public WebActionResult callService() {
    ...
    TmallCommodityDeleteBean reqBean = getBean();
...
//    DataIOService ioService = ServiceLocator.getDataIOService(getLoginInfo());
    ...
    for (TmallCommodityDeleteListBean commodity : reqBean.getList()) {
//      List<CCommodityDetail> detailList = service.getCCommoditySku(commodity.getShopCode(), commodity.getCommodityCode());

      ServiceResult result = service.deleteCCommodity(commodity.getShopCode(), commodity.getCommodityCode());
      ...
      //delete by os012 20111228 start 
//      else {
//        // SKU画像の削除
...
//      }
  ...
  public void prerender() {
    TmallCommodityDeleteBean reqBean = (TmallCommodityDeleteBean) getRequestBean();
