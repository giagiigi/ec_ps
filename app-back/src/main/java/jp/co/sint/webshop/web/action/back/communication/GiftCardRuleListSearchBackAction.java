 ...
 * @author OB.
 */
public class GiftCardRuleListSearchBackAction extends GiftCardRuleListSearchAction {
  ...
  public String getActionName() {
    return "web.action.back.communication.GiftCardRuleListSearchBackAction.0";
  }
