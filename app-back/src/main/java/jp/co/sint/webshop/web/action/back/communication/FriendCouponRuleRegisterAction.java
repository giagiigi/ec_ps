...
public class FriendCouponRuleRegisterAction extends FriendCouponRuleInitAction {
  ...
  public boolean validate() {
    ...
    FriendCouponRule F = service.selectFriendCouponRule(bean.getFriendCouponRuleNo());
    //验证比率和金额
  ...
  public WebActionResult callService() {
    ...
    // 增加
    CommunicationService service = ServiceLocator.getCommunicationService(getLoginInfo());
    ServiceResult result = service.addFriendCouponRule(friendcouponrule);
    // 登録処理の成功チェック
    if (result.hasError()) {
