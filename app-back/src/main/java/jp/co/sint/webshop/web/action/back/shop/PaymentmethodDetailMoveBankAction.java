 ...
 */
public class PaymentmethodDetailMoveBankAction extends WebBackAction<PaymentmethodDetailBean> {
  ...
  public WebActionResult callService() {
    ...
    setNextUrl("/app/shop/paymentmethod_bank/init/" + shopCode + "/" + bean.getPaymentMethodNo());
  ...
  public String getActionName() {
    return Messages.getString("web.action.back.shop.PaymentmethodDetailMoveBankAction.0");
  }
