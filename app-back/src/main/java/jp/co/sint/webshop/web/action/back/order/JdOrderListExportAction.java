 ...
 */
public class JdOrderListExportAction extends WebBackAction<JdOrderListBean> implements WebExportAction {
  ...
  public WebActionResult callService() {
    ...
    JdOrderListExportCondition jdOrderCondition = CsvExportType.EXPORT_CSV_JD_ISP.createConditionInstance();
    jdOrderCondition.setCondition(condition);
    this.exportCondition = jdOrderCondition;
  ...
  public String getActionName() {
    return Messages.getString("web.action.back.order.JdOrderListExportAction.0");
