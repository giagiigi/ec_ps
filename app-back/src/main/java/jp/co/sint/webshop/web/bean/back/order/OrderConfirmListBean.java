 ...
 */
public class OrderConfirmListBean extends UIBackBean implements UISearchBean {
	...
	public static class OrderSearchedBean implements Serializable {
	  ...
	  private String tmallBuyerMessage;
		...
		public String getRemarksForDisplay() {
			...
			if (StringUtil.hasValue(this.getMessage())) {
				builder.append(Messages
						.getString("web.bean.back.order.OrderListBean.0"));
				builder.append(this.getMessage());
				builder.append(" "); //$NON-NLS-1$
			}
			if (StringUtil.hasValue(this.getCaution())) {
				builder.append(Messages
						.getString("web.bean.back.order.OrderListBean.1"));
		 ...
		 */
		public void setSentPaymentReceivedMailList(
				List<String> sentPaymentReceivedMailList) {
		 ...
		 */
		public void setSentPaymentReminderMailList(
				List<String> sentPaymentReminderMailList) {
		...
		/**
		 * @param orderFlgName the orderFlgName to set
		 */
	 ...
	 */
	public void setSearchTargetedConnectedOrderData(
			String searchTargetedConnectedOrderData) {
	 ...
	 */
	public void setSearchOrderStatusList(
			List<CodeAttribute> searchOrderStatusList) {
	 ...
	 */
	public void setSearchShippingStatusList(
			List<CodeAttribute> searchShippingStatusList) {
	 ...
	 */
	public void setSearchShippingStatusSummary(
			List<String> searchShippingStatusSummary) {
	...
	public void createAttributes(RequestParameter reqparam) {
		...
		setSearchFromOrderDatetime(reqparam
				.getDateString("searchFromOrderDatetime"));
		setSearchToOrderDatetime(reqparam
				.getDateString("searchToOrderDatetime"));

		setSearchFromPaymentDatetime(reqparam
				.getDateString("searchFromPaymentDatetime"));
		setSearchToPaymentDatetime(reqparam
				.getDateString("searchToPaymentDatetime"));

		RegisterPaymentDateBean registerPaymentDate = new RegisterPaymentDateBean();
		registerPaymentDate.setRegisterPaymentDatetime(reqparam
				.getDateString("registerPaymentDatetime"));
		setRegisterPaymentDateBean(registerPaymentDate);

		setSearchOrderStatus(Arrays
				.asList(reqparam.getAll("searchOrderStatus")));
		setSearchShippingStatusSummary(Arrays.asList(reqparam
				.getAll("searchShippingStatusSummary")));
		setSearchReturnStatusSummary(Arrays.asList(reqparam
				.getAll("searchReturnStatusSummary")));

		setAdvancedSearchMode(reqparam.get("advancedSearchMode"));
		setSearchFixedSalesDataFlg(StringUtil.hasValue(reqparam
				.get("searchFixedSalesDataFlg")));
		setSearchDataTransportFlg(StringUtil.hasValue(reqparam
				.get("searchDataTransportFlg")));
		...
		setSearchFromOrderNo(StringUtil.toHalfWidth(reqparam
				.get("searchFromOrderNo")));
		setSearchToOrderNo(StringUtil.toHalfWidth(reqparam
				.get("searchToOrderNo")));

		// 検索条件-支払期限
		setSearchPaymentLimitOver(StringUtil.hasValue(reqparam
				.get("searchPaymentLimitOver")));
		setPaymentLimitDays(reqparam.get("paymentLimitDays"));
		setWithSentPaymentReminder(StringUtil.hasValue(reqparam
				.get("withSentPaymentReminder")));
    ...
    this.setContentFlg(reqparam.get("contentFlg"));
		// soukai add 2012/01/05 ob end
    this.setConfirmFlg(reqparam.get("confirmFlg"));
	}
	...
	public String getModuleName() {
		return Messages.getString("web.bean.back.order.OrderConfirmListBean.0");
	}
  ...
  public List<NameValue> getContentList() {
	 ...
	 */
	public void setRegisterPaymentDateBean(
			RegisterPaymentDateBean registerPaymentDateBean) {
	 ...
	 */
	public void setSearchReturnStatusSummary(
			List<String> searchReturnStatusSummary) {
