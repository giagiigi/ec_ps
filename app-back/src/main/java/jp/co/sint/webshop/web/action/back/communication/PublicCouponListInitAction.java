 ...
 * @author OB.
 */
public class PublicCouponListInitAction extends WebBackAction<PublicCouponListBean> {
  ...
  public WebActionResult callService() {
    ...
    PublicCouponListBean bean = createBean();
    setCompleteMessages();
    setNextUrl(null);
    setRequestBean(bean);
    setBean(bean);
   ...
   * @return 画面Bean
   */
  private PublicCouponListBean createBean() {

    PublicCouponListBean bean = new PublicCouponListBean();
