...
import jp.co.sint.webshop.web.bean.back.catalog.CategoryListBean;
 ...
 */
public class CategoryListExportAction extends WebBackAction<CategoryListBean> implements WebExportAction {
  ...
  public WebActionResult callService() {
    ...
    CategoryListBean searchBean = getBean();

    CategoryListExportCondition condition = CsvExportType.EXPORT_CSV_CATEGORY_LIST.createConditionInstance();
