 ...
 */
public class OrderDetailMoveModifyAction extends OrderDetailBaseAction {
  ...
  public WebActionResult callService() {
    ...
    if (orderHeader == null) {
      addErrorMessage(WebMessage.get(ServiceErrorMessage.NO_DATA_ERROR,
          Messages.getString("web.action.back.order.OrderDetailMoveModifyAction.0")));
      setRequestBean(bean);
    ...
    setNextUrl("/app/order/order_modify/init/" + bean.getOrderNo());
  ...
  public String getActionName() {
    return Messages.getString("web.action.back.order.OrderDetailMoveModifyAction.1");
  }
