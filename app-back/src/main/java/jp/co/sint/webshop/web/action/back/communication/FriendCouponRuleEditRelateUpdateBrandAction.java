 ...
 */
public class FriendCouponRuleEditRelateUpdateBrandAction extends FriendCouponRuleEditBaseAction {
  ...
  public WebActionResult callService() {
    ...
    if (getRequestParameter().getPathArgs() != null && getRequestParameter().getPathArgs().length > 0
      ...
      if (rule != null ) {
        rule.setObjectBrand(setBrandJoin(bean, rule));
        flag = true;
    ...
    if (getRequestParameter().getPathArgs() != null && getRequestParameter().getPathArgs().length > 0
      ...
      if (rule != null) {
        ...
        if (result.hasError()) {
          ...
          setNextUrl("/app/communication/friend_coupon_rule_eidt/init/" + bean.getFriendCouponRuleNo() +"/relatedDelete"+"/succeed");
        }
      }
    }
