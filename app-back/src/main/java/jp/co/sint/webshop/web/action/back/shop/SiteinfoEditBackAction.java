 ...
 */
public class SiteinfoEditBackAction extends WebBackAction<SiteinfoEditBean> {
  ...
  public void prerender() {
    ...
    requestBean.setRegisterButtonDisplay(false);
  ...
  public String getActionName() {
    return Messages.getString("web.action.back.shop.SiteinfoEditBackAction.0");
  }
