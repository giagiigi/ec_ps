 ...
 */
public class PublicCouponEditRelateUpdateCategoryAction extends PublicCouponEditBaseAction {
  ...
  public boolean validate() {
    ...
    if ("login".equals(getRequestParameter().getPathArgs()[0])) {
      ...
      NewCouponRule newCouponRule = communicationService.getPrivateCoupon(bean.getCouponId());
  ...
  public WebActionResult callService() {
    ...
    if (getRequestParameter().getPathArgs() != null && getRequestParameter().getPathArgs().length > 0
      ...
      if (newCouponRule != null) {
        ...
        if (result.hasError()) {
          ...
          setNextUrl("/app/communication/public_coupon_edit/init/" + bean.getCouponId() + "/categoryDelete" + "/succeed");
        }
      }
    }
    ...
    if (flag) {
      ...
      if (result.hasError()) {
        ...
        setNextUrl("/app/communication/public_coupon_edit/init/" + bean.getCouponId() + "/categoryLogin" + "/succeed");
      }
    }
