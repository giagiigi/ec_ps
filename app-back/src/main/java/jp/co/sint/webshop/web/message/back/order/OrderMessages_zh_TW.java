...
public class OrderMessages_zh_TW extends ListResourceBundle {
  ...
  private static final Object[][] ORDER_MESSAGES_MAIN1 = {
      {
          ...
          "still_shipping_order", "发货安排中或是以发货的订单信息。"
      }, {
          ...
          "delete_all_delivery", "配送地里最少需要１个配送地。"
      }, {
          "fixed_data", "该当的发货信息是以确认的销售额。"
      }, {
          "fixed_data_with_no", "发货编号:{0}是以确认的销售额。"
      }, {
  ...
  private static final Object[][] ORDER_MESSAGES_MAIN2 = new Object[][] {
      ...
      // 10.1.2 10110 追加 ここから
          ...
          "stock_concurrency_control_error", "現在非常混亂著。請稍微留出時間再一次訂購。"
