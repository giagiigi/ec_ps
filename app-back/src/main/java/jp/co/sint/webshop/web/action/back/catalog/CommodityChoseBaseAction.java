 ...
 */
public abstract class CommodityChoseBaseAction extends WebBackAction<CommodityChoseBean> {
  ...
  @Override
  public void init() {
    CommodityChoseBean bean = getBean();
   ...
   * @param bean
   */
  public void setDisplayControl(CommodityChoseBean bean) {
