 ...
 * @author OB.
 */
public class PrivateCouponBean extends UIBackBean implements UISearchBean {
  ...
  public String getModuleName() {
    return Messages.getString("web.bean.back.analysis.PrivateCouponBean.0");
  }
  ...
  public boolean isCSVDisplayFlg() {
    return CSVDisplayFlg;
  }

  public void setCSVDisplayFlg(boolean displayFlg) {
    CSVDisplayFlg = displayFlg;
  }
}
