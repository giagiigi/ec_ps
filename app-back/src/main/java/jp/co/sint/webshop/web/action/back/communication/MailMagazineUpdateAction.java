 ...
 */
public class MailMagazineUpdateAction extends MailMagazineInitAction {
  ...
  public WebActionResult callService() {
    ...
    mailMagazine.setUpdatedDatetime(bean.getUpdateDatetime());

    CommunicationService svc = ServiceLocator.getCommunicationService(getLoginInfo());
    ServiceResult result = svc.updateMailMagazine(mailMagazine);
    ...
    addInformationMessage(WebMessage.get(CompleteMessage.UPDATE_COMPLETE,
        Messages.getString("web.action.back.communication.MailMagazineUpdateAction.0")));
  ...
  public String getActionName() {
    return Messages.getString("web.action.back.communication.MailMagazineUpdateAction.1");
  }
