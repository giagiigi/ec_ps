 ...
 */
public class RelatedCategoryTreeRegisterAction extends WebBackAction<RelatedCategoryTreeBean> {
  ...
  public WebActionResult callService() {
    ...
    RelatedCategoryTreeBean reqBean = getBean();
    ...
    if (result.hasError()) {
      ...
      setNextUrl("/app/catalog/related_category_tree/init/" + "/" + reqBean.getShopCode()
