 ...
 */
public abstract class TmallCommodityListBaseAction extends WebBackAction<TmallCommodityListBean> {
  ...
  public void setCondition(CommodityListSearchCondition condition) {
    ...
    condition.setSearchCommodityType(getBean().getSearchCommidityType());
    condition.setSearchTmallMjsCommodityflg(getBean().getSearchTmallMjsCommodityflg());
   ...
   * @param bean
   */
  public void setDisplayControl(TmallCommodityListBean bean) {
