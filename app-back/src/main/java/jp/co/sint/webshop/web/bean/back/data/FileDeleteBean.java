...
/**
 * U1080410:ファイル削除のデータモデルです。
 * 
 * @author System Integrator Corp.
 */
public class FileDeleteBean extends UIBackBean implements UISearchBean {
  ...
  /** ファイル削除権限有無 true:削除するボタン表示 false:削除するボタン非表示 */
  private Boolean deleteAuthority = false;

  /** 検索ボタン表示有無 true:検索ボタン表示 false:検索ボタン非表示 */
  private Boolean searchButtonDisplay = false;
  ...
  /** 画像系コンテンツの有無 */
  private Boolean imageContents = false;

  private List<FileDeleteDetailBean> searchResultList = new ArrayList<FileDeleteDetailBean>();

  private PagerValue pagerValue;

  /**
   * U1080410:ファイル削除のサブモデルです。
   * 
   * @author System Integrator Corp.
   */
  public static class FileDeleteDetailBean implements Serializable {
  ...
  public String getModuleName() {
    return Messages.getString("web.bean.back.data.FileDeleteBean.0");
  }
   ...
   */
  public List<FileDeleteDetailBean> getSearchResultList() {
    return searchResultList;
  }
   ...
   *          searchResultList
   */
  public void setSearchResultList(List<FileDeleteDetailBean> searchResultList) {
  ...
  /**
   * searchButtonDisplayを取得します。
   * 
   * @return searchButtonDisplay
   */
  public Boolean getSearchButtonDisplay() {
    return searchButtonDisplay;
  }

  /**
   * searchButtonDisplayを設定します。
   * 
   * @param searchButtonDisplay
   *          searchButtonDisplay
   */
  public void setSearchButtonDisplay(Boolean searchButtonDisplay) {
    this.searchButtonDisplay = searchButtonDisplay;
  }
   ...
   */
  public Boolean getImageContents() {
    return imageContents;
  }
   ...
   *          imageContents
   */
  public void setImageContents(Boolean imageContents) {
