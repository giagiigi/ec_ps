 ...
 *
 */
public interface CCommodityExtDao extends GenericDao<CCommodityExt, Long> {
   ...
   */
  CCommodityExt loadByRowid(Long id);
   ...
   */
  CCommodityExt load(String shopCode, String commodityCode);
   ...
   */
  Long insert(CCommodityExt obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(CCommodityExt obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(CCommodityExt obj, LoginInfo loginInfo);
   ...
   */
  List<CCommodityExt> findByQuery(Query query);
   ...
   * @return 検索結果に相当するCampaignのリスト
   */
  List<CCommodityExt> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のCampaignのリスト
   */
  List<CCommodityExt> loadAll();
  
  List<CCommodityExt> loadAllByCommodityCode(String shopCode,String commodityCode);
