...
public interface ShippingDetailDao extends GenericDao<ShippingDetail, Long> {
   ...
   */
  ShippingDetail loadByRowid(Long id);
   ...
   */
  ShippingDetail load(String shippingNo, Long shippingDetailNo);
   ...
   */
  boolean exists(String shippingNo, Long shippingDetailNo);
   ...
   */
  Long insert(ShippingDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(ShippingDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(ShippingDetail obj, LoginInfo loginInfo);
   ...
   * @param shippingDetailNo 出荷明細番号
   */
  void delete(String shippingNo, Long shippingDetailNo);
   ...
   */
  List<ShippingDetail> findByQuery(Query query);
   ...
   * @return 検索結果に相当するShippingDetailのリスト
   */
  List<ShippingDetail> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のShippingDetailのリスト
   */
  List<ShippingDetail> loadAll();
