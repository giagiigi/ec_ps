...
/** 
 * 「手動リコメンド(RELATED_COMMODITY_A)」テーブルの1行分のレコードを表すDTO(Data Transfer Object)です。
 *
 * @author System Integrator Corp.
 *
 */
public class RelatedCommodityA implements Serializable, WebshopEntity {
  ...
  @Length(16)
  @AlphaNum2
  @Metadata(name = "リンク商品コード", order = 3)
