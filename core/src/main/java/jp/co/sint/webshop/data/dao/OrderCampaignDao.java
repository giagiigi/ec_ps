 ...
 *
 */
public interface OrderCampaignDao extends GenericDao<OrderCampaign, Long> {
   ...
   */
  OrderCampaign loadByRowid(Long id);
   ...
   */
  OrderCampaign load(String orderCode, String campaignCode);
   ...
   */
  boolean exists(String orderCode, String campaignCode);
  /**
   ...
   * @return 主キー列の値に対応するCampaignの行が存在すればtrue
   */
  boolean exists(String orderCode);
   ...
   */
  Long insert(OrderCampaign obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(OrderCampaign obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(OrderCampaign obj, LoginInfo loginInfo);
   ...
   * @param campaignCode キャンペーンコード
   */
  void delete(String orderCode, String campaignCode);
   ...
   */
  List<OrderCampaign> findByQuery(Query query);
   ...
   * @return 検索結果に相当するCampaignのリスト
   */
  List<OrderCampaign> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のCampaignのリスト
   */
  List<OrderCampaign> loadAll();
