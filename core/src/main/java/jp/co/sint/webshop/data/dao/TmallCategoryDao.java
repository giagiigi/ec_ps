 ...
 *
 */
public interface TmallCategoryDao extends GenericDao<TmallCategory, Long> {
   ...
   */
  TmallCategory loadByRowid(Long id);
   ...
   */
  TmallCategory load(String orderNo);
  /**
   ...
   */
  boolean exists(String categoryNo);
  /**
   ...
   */
  Long insert(TmallCategory obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(TmallCategory obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(TmallCategory obj, LoginInfo loginInfo);
   ...
   */
  List<TmallCategory> findByQuery(Query query);
   ...
   * @return 検索結果に相当するOrderHeaderのリスト
   */
  List<TmallCategory> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のOrderHeaderのリスト
   */
  List<TmallCategory> loadAll();

  /**
   * 查询所有子类别
   * @return
   */
  List<TmallCategory> loadAllChild();
