 ...
 *
 */
public interface TmallShippingDetailDao extends GenericDao<TmallShippingDetail, Long> {
   ...
   */
  TmallShippingDetail loadByRowid(Long id);
   ...
   */
  TmallShippingDetail load(String shippingNo, Long TmallShippingDetailNo);
   ...
   */
  boolean exists(String shippingNo, Long TmallShippingDetailNo);
   ...
   */
  Long insert(TmallShippingDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(TmallShippingDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(TmallShippingDetail obj, LoginInfo loginInfo);
   ...
   * @param TmallShippingDetailNo 出荷明細番号
   */
  void delete(String shippingNo, Long TmallShippingDetailNo);
   ...
   */
  List<TmallShippingDetail> findByQuery(Query query);
   ...
   * @return 検索結果に相当するTmallShippingDetailのリスト
   */
  List<TmallShippingDetail> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のTmallShippingDetailのリスト
   */
  List<TmallShippingDetail> loadAll();
