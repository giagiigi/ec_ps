...
public enum PaymentConfirmTag implements MailTemplateTag {
...
//  FIRST_NAME_KANA("[@FIRST_NAME_KANA@]", "名カナ", "タロウ"),
  ...
  //Add by V10-CH start
  /** 手机号码 */
  MOBILE_NUMBER("[@MOBIL_ENUMBER@]","手机号码","00000000000"),
  //Add by V10-CH end
  /** 郵便番号 */
...
//  ADDRESS4("[@ADDRESS4@]", "住所4", "×××マンション"),
  //modify by V10-CH 170 end  
  /** 支払方法名称 */
  PAYMENT_METHOD_NAME("[@PAYMENT_METHOD_NAME@]", "支払方法名称", "銀行振込", true),
  /** 支払手数料 */
  PAYMENT_COMMISSION("[@PAYMENT_COMMISSION@]", "支払手数料", "300円", true),
  /** 受注日時 */
  ...
  private PaymentConfirmTag(String value, String name, String dummyData, boolean required) {
    init(value, name, dummyData, required);
  }

  private PaymentConfirmTag(String value, String name, String dummyData) {
