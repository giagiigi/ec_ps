...
/** 
 * 「地域ブロック(REGION_BLOCK)」テーブルの1行分のレコードを表すDTO(Data Transfer Object)です。
 *
 * @author System Integrator Corp.
 *
 */
public class RegionBlock implements Serializable, WebshopEntity {
  ...
  @Required
  @Length(20)
  @Metadata(name = "地域ブロック名称", order = 3)
   ...
   * @param  val 地域ブロック名称
   */
  public void setRegionBlockName(String val) {
    this.regionBlockName = val;
  }
