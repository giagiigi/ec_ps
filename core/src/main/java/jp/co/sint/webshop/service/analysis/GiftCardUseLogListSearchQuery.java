...
public class GiftCardUseLogListSearchQuery extends AbstractQuery<GiftCardUseLogSummary> {

  /** serial version UID */
  private static final long serialVersionUID = 1L;

  /** default constructor */
  public GiftCardUseLogListSearchQuery() {
  }

  public GiftCardUseLogListSearchQuery(GiftCardUseLogSearchCondition condition) {
    ...
    if (StringUtil.hasValueAnyOf(condition.getSearchShippingStartDatetimeFrom(), condition.getSearchShippingStartDatetimeTo())) {
      ...
      SqlFragment fragment = dialect.createDateRangeClause("A.SHIPPING_DATE", DateUtil.fromString(condition
          .getSearchShippingStartDatetimeFrom()), DateUtil.fromString(condition.getSearchShippingStartDatetimeTo()), DateSearchAccuracy.DATE);
