 ...
 *
 */
public interface JdCityDao extends GenericDao<JdCity, Long> {
   ...
   */
  JdCity load(String countryCode, String regionCode,String cityCode);
   ...
   */
  Long insert(JdCity obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(JdCity obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(JdCity obj, LoginInfo loginInfo);
   ...
   */
  List<JdCity> findByQuery(Query query);
   ...
   * @return 検索結果に相当するRegionのリスト
   */
  List<JdCity> findByQuery(String sqlString, Object... params);
...
//2013/04/11 配送公司设定对应 ob add start
   ...
   * @return 城市信息
   */
  List<JdCity> load(String regionCode);
