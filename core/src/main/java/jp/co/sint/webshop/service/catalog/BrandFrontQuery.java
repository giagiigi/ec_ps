...
public class BrandFrontQuery extends AbstractQuery<CommodityKey> {
  ...
  private StringBuilder getInitializedBuffer() {
    ...
    // select clause
    b.append("SELECT B.SHOP_CODE, B.BRAND_CODE, B.BRAND_NAME,B.BRAND_ENGLISH_NAME,B.BRAND_JAPANESE_NAME, B.BRAND_NAME_ABBR, B.BRAND_DESCRIPTION," +
    		"B.BRAND_DESCRIPTION_EN,B.BRAND_DESCRIPTION_JP, SUM(CH.COMMODITY_POPULAR_RANK) COMMODITY_POPULAR_RANK, COUNT(CH.COMMODITY_CODE) COMMODITY_COUNT FROM BRAND B ");

    // from clause and joinees
    b.append("LEFT JOIN COMMODITY_LIST_VIEW CH ON B.BRAND_CODE = CH.BRAND_CODE  ");
  ...
  public BrandFrontQuery(CommodityContainerCondition condition) {
    ...
    // 並び順設定
    b.append(" GROUP BY B.SHOP_CODE, B.BRAND_CODE, B.BRAND_NAME, B.BRAND_NAME_ABBR, B.BRAND_DESCRIPTION ");
  ...
  private void setKeyWordCondition(CommodityContainerCondition condition, StringBuilder builder, List<Object> params) {
    ...
    String[] defaultSearchColumns = new String[] {
      "CH.COMMODITY_CODE", "CH.COMMODITY_NAME","CH.COMMODITY_NAME_EN", "CH.COMMODITY_NAME_JP",
      "CH.SHADOW_SEARCH_WORDS",
      "CH.COMMODITY_DESCRIPTION_PC", "CH.COMMODITY_DESCRIPTION_MOBILE",
      "CH.COMMODITY_DESCRIPTION_PC_EN", "CH.COMMODITY_DESCRIPTION_MOBILE_EN",
      "CH.COMMODITY_DESCRIPTION_PC_JP", "CH.COMMODITY_DESCRIPTION_MOBILE_JP",
    ...
    if (!searchWordList.isEmpty()) {
      ...
      for (int i = 0; i < searchWordList.size(); i++) {
        ...
        builder.append(" OR (SELECT BRAND_NAME,BRAND_ENGLISH_NAME,BRAND_JAPANESE_NAME, B.BRAND_DESCRIPTION,B.BRAND_DESCRIPTION_EN,B.BRAND_DESCRIPTION_JP FROM BRAND WHERE BRAND_CODE = CH.BRAND_CODE) LIKE ? ");
