 ...
 *
 */
public enum SmsType implements CodeAttribute {
  ...
  COUPON_START("优惠劵利用开始通知", "18"),
  
  COUPON_END("优惠劵利用结束通知", "19");
  ...
  private SmsType(String name, String value) {
    this.name = name;
    this.value = value;
  }
  /**
   ...
   * @return メールタイプ
   */
  public static SmsType fromValue(String value) {
    for (SmsType p : SmsType.values()) {
   ...
   * @return メールタイプ
   */
  public static SmsType fromValue(Long value) {
