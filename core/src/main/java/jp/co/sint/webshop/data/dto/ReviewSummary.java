...
/** 
 * 「レビュー点数集計(REVIEW_SUMMARY)」テーブルの1行分のレコードを表すDTO(Data Transfer Object)です。
 *
 * @author System Integrator Corp.
 *
 */
public class ReviewSummary implements Serializable, WebshopEntity {
  ...
  @Required
  @Length(3)
  @Metadata(name = "レビュー点数", order = 3)
  private Long reviewScore;

  /** レビュー件数 */
  @Required
  @Length(8)
  @Metadata(name = "レビュー件数", order = 4)
   ...
   * @param  val レビュー件数
   */
  public void setReviewCount(Long val) {
