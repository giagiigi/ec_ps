 ...
 *
 */
public interface JdDeliveryLocationDao extends GenericDao<JdDeliveryLocation, Long> {
   ...
   */
  JdDeliveryLocation loadByRowid(Long id);
   ...
   */
  JdDeliveryLocation load(String shopCode, String deliveryCompanyNo, String prefectureCode, String cityCode ,String areaCode);
  /**
   * 主キー列の値を指定してキャンペーンのインスタンスを取得します。
   * @param shopCode ショップコード
   * @param deliveryCompanyNo 配送会社コード
   ...
   */
  List<JdDeliveryLocation> load(String shopCode, String deliveryCompanyNo);
  /**
   ...
   */
  Long insert(JdDeliveryLocation obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(JdDeliveryLocation obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(JdDeliveryLocation obj, LoginInfo loginInfo);
   ...
   */
  List<JdDeliveryLocation> findByQuery(Query query);
   ...
   * @return 検索結果に相当するDeliveryLocationのリスト
   */
  List<JdDeliveryLocation> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のDeliveryLocationのリスト
   */
  List<JdDeliveryLocation> loadAll();
