...
public enum OrderHeaderTag implements MailTemplateTag {
...
//  ADDRESS4("[@ADDRESS4@]", "住所4", "×××マンション"),
  ...
  // add by lc 2012-04-12 start
  /** 优惠金额 */
  COUPON_TOTAL_PRICE("[@COUPON_TOTAL_PRICE@]", "优惠金额", "500円"),
    // add by lc 2012-04-12 end
  
  Gift_CARD_USE_PRICE("[@Gift_CARD_USE_PRICE@]", "礼品卡使用金额", "500円"),
  
  OUTER_CARD_PRICE("[@OUTER_CARD_PRICE@]", "外卡手续费", "500円");
