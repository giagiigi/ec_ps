 ...
 */
public interface JdStockDao extends GenericDao<JdStock, Long> {
   ...
   */
  JdStock load(String shopCode, String skuCode);
   ...
   */
  Long insert(JdStock obj, LoginInfo loginInfo);
   ...
   *          ログイン情報
   */
  void update(JdStock obj, LoginInfo loginInfo);
   ...
   *          ログイン情報
   */
  void delete(JdStock obj, LoginInfo loginInfo);
   ...
   */
  List<JdStock> findByQuery(Query query);
   ...
   * @return 検索結果に相当するJdStockAllocationのリスト
   */
  List<JdStock> findByQuery(String sqlString, Object... params);
