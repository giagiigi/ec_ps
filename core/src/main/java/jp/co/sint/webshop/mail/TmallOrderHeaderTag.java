...
public enum TmallOrderHeaderTag implements MailTemplateTag {
...
//  ADDRESS4("[@ADDRESS4@]", "住所4", "×××マンション"),
  ...
  private TmallOrderHeaderTag(String value, String name, String dummyData) {
    init(value, name, dummyData, false);
  }

  private TmallOrderHeaderTag(String value, String name, String dummyData, boolean initRequired) {
