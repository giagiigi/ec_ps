...
public enum ShippingDetailTag implements MailTemplateTag {
  /** 商品名称 */
  ...
  private ShippingDetailTag(String value, String name, String dummyData, boolean required) {
    init(value, name, dummyData, required);
  }

  private ShippingDetailTag(String value, String name, String dummyData) {
