 ...
 *
 */
public interface TmallPropertyDao extends GenericDao<TmallProperty, Long> {
   ...
   */
  TmallProperty loadByRowid(Long id);
   ...
   */
  TmallProperty load(String orderNo);
  /**
   ...
   */
  Long insert(TmallProperty obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(TmallProperty obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(TmallProperty obj, LoginInfo loginInfo);
   ...
   */
  List<TmallProperty> findByQuery(Query query);
   ...
   * @return 検索結果に相当するOrderHeaderのリスト
   */
  List<TmallProperty> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のOrderHeaderのリスト
   */
  List<TmallProperty> loadAll();
   ...
   * @return 属性集合
   */
  List<TmallProperty> loadCProByCategoryId(String categoryId);
  /**
   * 查询类目下属SKU属性
   * @param categoryId 类目ID
   * @return 属性集合
   */
  List<TmallProperty> loadSkuProByCategoryId(String categoryId);

  TmallProperty load(String categoryId,String propertyId);
}
