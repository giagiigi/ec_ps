...
/**
 * 「出荷ヘッダ(TMALL_SHIPPING_HEADER)」テーブルの1行分のレコードを表すDTO(Data Transfer Object)です。
 * 
 * @author System Integrator Corp.
 */
public class TmallShippingHeader implements Serializable, WebshopEntity {
  ...
  @Metadata(name = "都道府県コード", order = 11)
  ...
  @Metadata(name = "住所1", order = 12)
  private String address1;

  /** 住所2 */
  @Required
  @Length(50)
  @Metadata(name = "住所2", order = 13)
  private String address2;

  /** 住所3 */

  @Length(50)
  @Metadata(name = "住所3", order = 14)
  private String address3;

  /** 住所4 */
  @Required
  @Length(100)
  @Metadata(name = "住所4", order = 15)
  ...
  /** 淘宝发货标志 */
  @Length(1)
  @Metadata(name = "淘宝发货标志", order = 50)
  private Long tmallShippingFlg;

  /** 出荷ステータスWms */
  @Length(1)
  @Metadata(name = "出荷ステータスWms", order = 51)
  private Long shippingStatusWms;

  // 发货detail信息集合
  private List<TmallShippingDetail> shippingDetailList = new ArrayList<TmallShippingDetail>();

  public List<TmallShippingDetail> getShippingDetailList() {
    return shippingDetailList;
  }

  public void setShippingDetailList(List<TmallShippingDetail> shippingDetailList) {
  ...
  public Long getTmallShippingFlg() {
    return tmallShippingFlg;
  }

  public void setTmallShippingFlg(Long tmallShippingFlg) {
    this.tmallShippingFlg = tmallShippingFlg;
  }
