...
/** 
 * 「SKU別売上集計(SALES_AMOUNT_BY_SKU)」テーブルの1行分のレコードを表すDTO(Data Transfer Object)です。
 *
 * @author System Integrator Corp.
 *
 */
public class SalesAmountBySku implements Serializable, WebshopEntity {
  ...
  @PrimaryKey(1)
  @Length(38)
  @Metadata(name = "SKU別売上集計ID", order = 1)
  private Long salesAmountBySkuId;
  ...
  /** 商品SKU名称 */
  @Length(100)
  @Metadata(name = "商品SKU名称", order = 7)
  private String commoditySkuName;

  /** 商品金額累計 */
  @Precision(precision = 10, scale = 2)
  @Currency
  @Metadata(name = "商品金額累計", order = 8)
  private BigDecimal totalSalesPrice;

  /** 商品消費税額累計 */
  @Precision(precision = 10, scale = 2)
  @Currency
  @Metadata(name = "商品消費税額累計", order = 9)
  private BigDecimal totalSalesPriceTax;

  /** ギフト金額累計 */
  @Precision(precision = 10, scale = 2)
  @Currency
  @Metadata(name = "ギフト金額累計", order = 10)
  private BigDecimal totalGiftPrice;

  /** ギフト消費税額累計 */
  @Precision(precision = 10, scale = 2)
  @Currency
  @Metadata(name = "ギフト消費税額累計", order = 11)
  private BigDecimal totalGiftTax;

  /** 値引額累計 */
  @Precision(precision = 10, scale = 2)
  @Currency
  @Metadata(name = "値引額累計", order = 12)
  private BigDecimal totalDiscountAmount;

  /** 注文個数累計 */
  @Length(8)
  @Quantity
  @Metadata(name = "注文個数累計", order = 13)
  private Long totalOrderQuantity;

  /** 返品個数累計 */
  @Length(8)
  @Quantity
  @Metadata(name = "返品個数累計", order = 14)
  private Long totalReturnItemQuantity;

  /** 返金額累計 */
  @Precision(precision = 10, scale = 2)
  @Currency
  @Metadata(name = "返金額累計", order = 15)
   ...
   * @return SKU別売上集計ID
   */
  public Long getSalesAmountBySkuId() {
    return this.salesAmountBySkuId;
  }
   ...
   * SKU別売上集計IDを設定します
   *
   * @param  val SKU別売上集計ID
   */
  public void setSalesAmountBySkuId(Long val) {
    this.salesAmountBySkuId = val;
  }
   ...
   * @param  val 商品SKU名称
   */
  public void setCommoditySkuName(String val) {
    this.commoditySkuName = val;
  }
   ...
   * @param  val 注文個数累計
   */
  public void setTotalOrderQuantity(Long val) {
    this.totalOrderQuantity = val;
  }
   ...
   * @param  val 返品個数累計
   */
  public void setTotalReturnItemQuantity(Long val) {
    this.totalReturnItemQuantity = val;
  }
