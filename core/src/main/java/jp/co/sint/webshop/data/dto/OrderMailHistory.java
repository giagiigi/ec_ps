 ...
 *
 */
public class OrderMailHistory implements Serializable, WebshopEntity {
  ...
  private Long orderMailHistoryId;
   ...
   * @return 受注メール送信履歴ID
   */
  public Long getOrderMailHistoryId() {
    return this.orderMailHistoryId;
  }
   ...
   */
  public void setOrderMailHistoryId(Long val) {
    this.orderMailHistoryId = val;
  }
