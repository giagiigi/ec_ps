 ...
 */
public class ActivateCouponProcedure implements ProcedureDelegate {
  ...
  public ActivateCouponProcedure() {
  }

  public ActivateCouponProcedure(String orderNo, String updatedUser) {
    setOrderNo(orderNo);
  ...
  public String getStatement() {
    return "{CALL ACTIVATE_COUPON_PROC(?,?,?)}";
  }
