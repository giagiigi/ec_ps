...
public enum PaymentConfirmTag implements SmsTemplateTag {
...
//  ADDRESS4("[@ADDRESS4@]", "住所4", "×××マンション"),
  //modify by V10-CH 170 end  
  /** 支払方法名称 */
  PAYMENT_METHOD_NAME("[@PAYMENT_METHOD_NAME@]", "支払方法名称", "銀行振込"),
  /** 支払手数料 */
  PAYMENT_COMMISSION("[@PAYMENT_COMMISSION@]", "支払手数料", "300円"),
  /** 受注日時 */
