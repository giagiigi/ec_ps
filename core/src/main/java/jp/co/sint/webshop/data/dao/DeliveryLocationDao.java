 ...
 *
 */
public interface DeliveryLocationDao extends GenericDao<DeliveryLocation, Long> {
   ...
   */
  DeliveryLocation loadByRowid(Long id);
   ...
   */
  DeliveryLocation load(String shopCode, String deliveryCompanyNo, String prefectureCode, String cityCode ,String areaCode);
  /**
   * 主キー列の値を指定してキャンペーンのインスタンスを取得します。
   * @param shopCode ショップコード
   * @param deliveryCompanyNo 配送会社コード
   ...
   */
  List<DeliveryLocation> load(String shopCode, String deliveryCompanyNo);
  /**
   ...
   */
  Long insert(DeliveryLocation obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(DeliveryLocation obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(DeliveryLocation obj, LoginInfo loginInfo);
   ...
   */
  List<DeliveryLocation> findByQuery(Query query);
   ...
   * @return 検索結果に相当するDeliveryLocationのリスト
   */
  List<DeliveryLocation> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のDeliveryLocationのリスト
   */
  List<DeliveryLocation> loadAll();
