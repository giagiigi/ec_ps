 ...
 *
 */
public interface JdShippingDetailDao extends GenericDao<JdShippingDetail, Long> {
   ...
   */
  JdShippingDetail loadByRowid(Long id);
   ...
   */
  JdShippingDetail load(String shippingNo, Long TmallShippingDetailNo);
   ...
   */
  Long insert(JdShippingDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(JdShippingDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(JdShippingDetail obj, LoginInfo loginInfo);
   ...
   */
  List<JdShippingDetail> findByQuery(Query query);
   ...
   * @return 検索結果に相当するTmallShippingDetailのリスト
   */
  List<JdShippingDetail> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のTmallShippingDetailのリスト
   */
  List<JdShippingDetail> loadAll();
