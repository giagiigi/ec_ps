...
public class CategoryListCsvSchema extends CsvSchemaImpl {

  public CategoryListCsvSchema() {
    ...
    columns.add(new CsvColumnImpl("CATEGORY_NAME_PC", Messages.getCsvKey("service.data.csv.TmallCategoryListCsvSchema.1"), CsvDataType.STRING));
  ...
  public String getExportConfigureId() {
    return "CategoryListExportDataSource";
  }
