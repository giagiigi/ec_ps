 ...
 *
 */
public interface PrefectureDao extends GenericDao<Prefecture, Long> {
   ...
   */
  Prefecture loadByRowid(Long id);
   ...
   */
  Prefecture load(String prefectureCode);
   ...
   */
  Long insert(Prefecture obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(Prefecture obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(Prefecture obj, LoginInfo loginInfo);
   ...
   */
  List<Prefecture> findByQuery(Query query);
   ...
   * @return 検索結果に相当するPrefectureのリスト
   */
  List<Prefecture> findByQuery(String sqlString, Object... params);
