 ...
 * 
 */
public interface DeliveryRegionDao extends GenericDao<DeliveryRegion, Long> {
   ...
   */
  Long insert(DeliveryRegion obj, LoginInfo loginInfo);
   ...
   */
  void update(DeliveryRegion obj, LoginInfo loginInfo);
   ...
   */
  void delete(DeliveryRegion obj, LoginInfo loginInfo);
   ...
   * @return 配送会社信息List
   */
  List<DeliveryRegion> findByQuery(Query query);
   ...
   * @return 配送会社表信息List
   */
  List<DeliveryRegion> findByQuery(String sqlString, Object... params);
