 ...
 *
 */
public interface DescribeImgHistoryDao extends GenericDao<DescribeImgHistory, Long> {
   ...
   */
  DescribeImgHistory loadByRowid(Long id);
   ...
   */
  DescribeImgHistory load(String shopCode, String commodity_code);
   ...
   */
  Long insert(DescribeImgHistory obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ���O�C�����
   */
  void update(DescribeImgHistory obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ���O�C�����
   */
  void delete(DescribeImgHistory obj, LoginInfo loginInfo);
   ...
   */
  List<DescribeImgHistory> findByQuery(Query query);
   ...
   * @return ����ʂɑ�������CommodityDescribe�̃��X�g
   */
  List<DescribeImgHistory> findByQuery(String sqlString, Object... params);

  /**
   * �e�[�u���̑S�f�[�^��ꊇ�Ŏ擾���܂��B
   * @return �e�[�u���̑S�f�[�^����CommodityDescribe�̃��X�g
   */
  List<DescribeImgHistory> loadAll();
