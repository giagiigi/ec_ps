...
/** 
 * 「同報配信メールキューヘッダ(BROADCAST_MAILQUEUE_HEADER)」テーブルの1行分のレコードを表すDTO(Data Transfer Object)です。
 *
 * @author System Integrator Corp.
 *
 */
public class BroadcastMailqueueHeader implements Serializable, WebshopEntity {
  ...
  @Metadata(name = "メール送信ステータス", order = 8)
