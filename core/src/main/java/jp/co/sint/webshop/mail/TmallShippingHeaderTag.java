...
public enum TmallShippingHeaderTag implements MailTemplateTag {
  /** 宛名：姓 */
...
//  ADDRESS4("[@ADDRESS4@]", "住所4", "×××マンション"),
  ...
  private TmallShippingHeaderTag(String value, String name, String dummyData, boolean required) {
    init(value, name, dummyData, required);
  }

  private TmallShippingHeaderTag(String value, String name, String dummyData) {
