 ...
 *
 */
public interface OrderHeaderDao extends GenericDao<OrderHeader, Long> {
   ...
   */
  OrderHeader loadByRowid(Long id);
   ...
   */
  OrderHeader load(String orderNo);
   ...
   */
  Long insert(OrderHeader obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(OrderHeader obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(OrderHeader obj, LoginInfo loginInfo);
   ...
   */
  List<OrderHeader> findByQuery(Query query);
   ...
   * @return 検索結果に相当するOrderHeaderのリスト
   */
  List<OrderHeader> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のOrderHeaderのリスト
   */
  List<OrderHeader> loadAll();
