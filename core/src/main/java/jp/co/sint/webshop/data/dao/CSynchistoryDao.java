 ...
 *
 */
public interface CSynchistoryDao extends GenericDao<CSynchistory, Long> {
   ...
   */
  CSynchistory loadByRowid(Long id);
   ...
   */
  CSynchistory load(String synchCode);
   ...
   */
  boolean exists(String synchCode);
   ...
   */
  Long insert(CSynchistory obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(CSynchistory obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(CSynchistory obj, LoginInfo loginInfo);
   ...
   */
  List<CSynchistory> findByQuery(Query query);
   ...
   * @return 検索結果に相当するCommodityDetailのリスト
   */
  List<CSynchistory> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のCommodityDetailのリスト
   */
  List<CSynchistory> loadAll();
