...
public interface OrderDetailDao extends GenericDao<OrderDetail, Long> {
   ...
   */
  OrderDetail loadByRowid(Long id);
   ...
   */
  OrderDetail load(String orderNo, String shopCode, String skuCode);
   ...
   */
  Long insert(OrderDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(OrderDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(OrderDetail obj, LoginInfo loginInfo);
   ...
   */
  List<OrderDetail> findByQuery(Query query);
   ...
   * @return 検索結果に相当するOrderDetailのリスト
   */
  List<OrderDetail> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のOrderDetailのリスト
   */
  List<OrderDetail> loadAll();
