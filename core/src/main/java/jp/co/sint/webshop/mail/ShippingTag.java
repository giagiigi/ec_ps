...
public enum ShippingTag implements MailTemplateTag {
...
//  ADDRESS4("[@ADDRESS4@]", "住所4", "×××マンション"),
  ...
  /** 优惠金额 */
  DISCOUNT_PRICE("[@DISCOUNT_PRICE@]", "优惠金额", "500.00"),
  /** 优惠金额 */
  GIFT_CARD_USE_PRICE("[@GIFT_CARD_USE_PRICE@]", "礼品卡使用金额", "500.00"),
  
  OUTER_CARD_PRICE("[@OUTER_CARD_PRICE@]", "外卡手续费", "500.00");
