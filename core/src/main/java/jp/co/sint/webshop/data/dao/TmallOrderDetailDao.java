 ...
 *
 */
public interface TmallOrderDetailDao extends GenericDao<TmallOrderDetail, Long> {
   ...
   */
  TmallOrderDetail loadByRowid(Long id);
   ...
   */
  TmallOrderDetail load(String orderNo, String shopCode, String skuCode);
   ...
   */
  Long insert(TmallOrderDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(TmallOrderDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(TmallOrderDetail obj, LoginInfo loginInfo);
   ...
   */
  List<TmallOrderDetail> findByQuery(Query query);
   ...
   * @return 検索結果に相当するOrderDetailのリスト
   */
  List<TmallOrderDetail> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のOrderDetailのリスト
   */
  List<TmallOrderDetail> loadAll();
