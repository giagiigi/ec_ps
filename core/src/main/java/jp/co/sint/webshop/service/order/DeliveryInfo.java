...
/**
 * AbstractDeliveryCompany entity provides the base persistence definition of the DeliveryCompany
 * @author OB
 */

public class DeliveryInfo implements Serializable, WebshopEntity {
  ...
  /**
   * 设置配送希望日区分
   * @param deliveryDateType deliveryDateType
   */
  ...
  public void setUpdatedDatetime(Date updatedDatetime) {
	...
	/**
	 * @param deliveryRelatedInfoNo the deliveryRelatedInfoNo to set
	 */
	...
	/**
	 * @param deliveryAppointedTimeType the deliveryAppointedTimeType to set
	 */
	...
	/**
	 * @param deliveryAppointedStartTime the deliveryAppointedStartTime to set
	 */
	...
	/**
	 * @param deliveryAppointedEndTime the deliveryAppointedEndTime to set
	 */
