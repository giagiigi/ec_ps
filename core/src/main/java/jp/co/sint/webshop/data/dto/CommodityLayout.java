...
/** 
 * 「商品レイアウト(COMMODITY_LAYOUT)」テーブルの1行分のレコードを表すDTO(Data Transfer Object)です。
 *
 * @author System Integrator Corp.
 *
 */
public class CommodityLayout implements Serializable, WebshopEntity {
   ...
   * @param  val パーツコード
   */
  public void setPartsCode(String val) {
    this.partsCode = val;
  }
