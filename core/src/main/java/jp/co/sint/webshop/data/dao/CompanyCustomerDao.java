 ...
 *
 */
public interface CompanyCustomerDao extends GenericDao<CompanyCustomer, Long> {
   ...
   */
  CompanyCustomer loadByRowid(Long id);
   ...
   */
  CompanyCustomer load(String companyCode);
   ...
   */
  boolean exists(String companyCode);
   ...
   */
  Long insert(CompanyCustomer obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(CompanyCustomer obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(CompanyCustomer obj, LoginInfo loginInfo);
   ...
   */
  List<CompanyCustomer> findByQuery(Query query);
   ...
   * @return 検索結果に相当するCampaignのリスト
   */
  List<CompanyCustomer> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のCampaignのリスト
   */
  List<CompanyCustomer> loadAll();
