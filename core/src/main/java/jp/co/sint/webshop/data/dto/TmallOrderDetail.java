...
/**
 * 「受注明細(TMALL_ORDER_DETAIL)」テーブルの1行分のレコードを表すDTO(Data Transfer Object)です。
 * 
 * @author System Integrator Corp.
 */
public class TmallOrderDetail implements Serializable, WebshopEntity {
  ...
  @Length(16)
  @Metadata(name = " ", order = 25)
  private String salePlanCode;
  
  @Length(50)
  @Metadata(name = " ", order = 26)
  private String salePlanName;
  
  
  @Length(16)
  @Metadata(name = " ", order = 27)
  private String featuredPlanCode;
  
  @Length(50)
  @Metadata(name = " ", order = 28)
  private String featuredPlanName;
  
  @Length(16)
  @Metadata(name = " ", order = 29)
  private String brandCode;
  
  @Length(50)
  @Metadata(name = " ", order = 30)
  private String brandName;
  
  @Length(24)
  @Metadata(name = " ", order = 31)
  private String tmallSkuCode;
  
  @Length(16)
  @Metadata(name = " ", order = 32)
  private String tmallCommodityCode;
  
  /** 交易修改时间 */
  @Required
  @Metadata(name = "交易修改时间", order = 33)
  private Date tmallModifiedTime; 
  
  @Precision(precision = 10, scale = 2)
  @Currency
  @Metadata(name = "实际退款金额 ", order = 34)
  private BigDecimal tmallRefundPaidPrice;
  
  @Precision(precision = 10, scale = 2)
  @Currency  
  @Metadata(name = "淘宝退款ID", order = 35)
  private String tmallRefundId ;
  
  @Length(50)
  @Metadata(name = "退款状态 ", order = 36)
  private String tmallRefundStatus;
  
  //TMALL订单下载时组合品需要用的字段
  private TmallShippingDetailComposition tShDetailC;
  
  //TMALL订单下载时套装品需要用的字段
  private List<TmallShippingDetailComposition> suitShDetailList = new ArrayList<TmallShippingDetailComposition>();
  
  /**
   * @return the tShDetailC
   */
  public TmallShippingDetailComposition getTShDetailC() {
    return tShDetailC;
  }
  /**
   * @param shDetailC the tShDetailC to set
   */
  public void setTShDetailC(TmallShippingDetailComposition shDetailC) {
    tShDetailC = shDetailC;
  }
  ...
  /**
   * @param tmallRefundStatus the tmallRefundStatus to set
   */
  public void setTmallRefundStatus(String tmallRefundStatus) {
    this.tmallRefundStatus = tmallRefundStatus;
  }

  /**
   * @return the tmallRefundStatus
   */
  public String getTmallRefundStatus() {
    return tmallRefundStatus;
  }
  ...
  /**
   * @param tmallSkuCode the tmallSkuCode to set
   */
  public void setTmallSkuCode(String tmallSkuCode) {
    this.tmallSkuCode = tmallSkuCode;
  }

  /**
   * @return the tmallSkuCode
   */
  ...
  /**
   * @param tmallModifiedTime the tmallModifiedTime to set
   */
  ...
  /**
   * @param tmallRefundPaidPrice the tmallRefundPaidPrice to set
   */
  public void setTmallRefundPaidPrice(BigDecimal tmallRefundPaidPrice) {
    this.tmallRefundPaidPrice = tmallRefundPaidPrice;
  }

  /**
   * @return the tmallRefundPaidPrice
   */
  public BigDecimal getTmallRefundPaidPrice() {
    return tmallRefundPaidPrice;
  }

  /**
   * @param tmallRefundId the tmallRefundId to set
   */
  public void setTmallRefundId(String tmallRefundId) {
    this.tmallRefundId = tmallRefundId;
  }

  /**
   * @return the tmallRefundId
   */
  public String getTmallRefundId() {
    return tmallRefundId;
  }
  
  /**
   * @return the suitShDetailList
   */
  public List<TmallShippingDetailComposition> getSuitShDetailList() {
    return suitShDetailList;
  }
  
  /**
   * @param suitShDetailList the suitShDetailList to set
   */
  public void setSuitShDetailList(List<TmallShippingDetailComposition> suitShDetailList) {
    this.suitShDetailList = suitShDetailList;
  }
