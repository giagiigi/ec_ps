 ...
 *
 */
public interface CampaignMainDao extends GenericDao<CampaignMain, Long> {
   ...
   */
  CampaignMain loadByRowid(Long id);
   ...
   */
  CampaignMain load(String campaignCode);
   ...
   */
  Long insert(CampaignMain obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(CampaignMain obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(CampaignMain obj, LoginInfo loginInfo);
   ...
   */
  List<CampaignMain> findByQuery(Query query);
   ...
   * @return 検索結果に相当するCampaignのリスト
   */
  List<CampaignMain> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のCampaignのリスト
   */
  List<CampaignMain> loadAll();
