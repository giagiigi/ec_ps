 ...
 * 
 */
public interface JdDeliveryRegionDao extends GenericDao<JdDeliveryRegion, Long> {
   ...
   */
  Long insert(JdDeliveryRegion obj, LoginInfo loginInfo);
   ...
   */
  void update(JdDeliveryRegion obj, LoginInfo loginInfo);
   ...
   */
  void delete(JdDeliveryRegion obj, LoginInfo loginInfo);
   ...
   * @return 配送会社信息List
   */
  List<JdDeliveryRegion> findByQuery(Query query);
   ...
   * @return 配送会社表信息List
   */
  List<JdDeliveryRegion> findByQuery(String sqlString, Object... params);
