 ...
 *
 */
public interface JdAreaDao extends GenericDao<JdArea, Long> {
   ...
   */
  Long insert(JdArea obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(JdArea obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(JdArea obj, LoginInfo loginInfo);
   ...
   */
  List<JdArea> findByQuery(Query query);
   ...
   * @return 検索結果に相当するAreaのリスト
   */
  List<JdArea> findByQuery(String sqlString, Object... params);
   ...
   * @return 区县信息
   */
  List<JdArea> load(String prefectureCode, String cityCode);
