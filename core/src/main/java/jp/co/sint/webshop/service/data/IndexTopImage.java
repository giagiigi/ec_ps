...
public class IndexTopImage implements ImageInfo {
  ...
  public IndexTopImage() {
  }

  public IndexTopImage(String shopCode, String contentStaticCode, String languageCode) {
  ...
  public ContentsType getContentsType() {
    return ContentsType.INDEX_TOP_IMAGE;
  }
  ...
  public String[] getSuffixies() {
    String[] suffixies = {
      ImageType.INDEX_TOP_IMAGE.getSuffix()
    };
    return suffixies;
  }
