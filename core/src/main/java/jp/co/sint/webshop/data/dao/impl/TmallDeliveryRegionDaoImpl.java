 ...
 * 
 */
public class TmallDeliveryRegionDaoImpl implements TmallDeliveryRegionDao, Serializable {

	/** Serial Version UID */
	private static final long serialVersionUID = -1;

	/** Generic Dao */
	private GenericDaoImpl<TmallDeliveryRegion, Long> genericDao;
	 ...
	 * Constructor:
	 */
	public TmallDeliveryRegionDaoImpl() {
		genericDao = new GenericDaoImpl<TmallDeliveryRegion, Long>(
		    TmallDeliveryRegion.class);
	}
	 ...
	 *            删除人信息
	 */
	public void delete(TmallDeliveryRegion obj, LoginInfo loginInfo) {
	 ...
	 * @return 配送会社表信息List
	 */
	public List<TmallDeliveryRegion> findByQuery(Query query) {
	 ...
	 * @return 配送会社信息列表
	 */
	public List<TmallDeliveryRegion> findByQuery(String sqlString, Object... params) {
	 ...
	 */
	public Long insert(TmallDeliveryRegion obj, LoginInfo loginInfo) {
	 ...
	 * @return 全部的配送会社信息列表
	 */
	public List<TmallDeliveryRegion> loadAll() {
...
//	}
	 ...
	 *            更新人信息
	 */
	public void update(TmallDeliveryRegion obj, LoginInfo loginInfo) {
	 ...
	 *            删除的任务信息
	 */
	public void delete(TmallDeliveryRegion transactionObject) {
	 ...
	 * @return 添加成功时返回任务编号
	 */
	public Long insert(TmallDeliveryRegion transactionObject) {
	 ...
	 *            任务信息
	 */
	public void update(TmallDeliveryRegion transactionObject) {
	 ...
	 * @return id对应应配送公司信息
	 */
	public TmallDeliveryRegion loadByRowid(Long id) {
	...
	public boolean exists(String shopCode, String deliveryCompanyNo, String prefectureCode) {
		...
		final String query = "SELECT COUNT(*) FROM TMALL_DELIVERY_REGION"
	...
	public void deleteAll(String shopCode, String deliveryCompanyNo) {
		Object[] params = new Object[] { shopCode, deliveryCompanyNo };
		final String query = "DELETE FROM TMALL_DELIVERY_REGION"
	 ...
	 * @return 指定的配送会社信息
	 */
//	public DeliveryRegion load(String deliveryCompanyNo) {
