...
public enum CouponStartTag implements SmsTemplateTag {
  /** 姓名 */
  LAST_NAME("[@NAME@]", "姓", "山田"),
  //2013/04/15 优惠券对应 ob add start
  /** 优惠劵名称 */
  COUPON_NAME("[@COUPON_NAME@]", "优惠劵名称", "满200-50优惠券"),
  ...
  private CouponStartTag(String value, String name, String dummyData) {
