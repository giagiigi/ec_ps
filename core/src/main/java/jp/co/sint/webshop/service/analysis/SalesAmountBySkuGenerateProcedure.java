...
public class SalesAmountBySkuGenerateProcedure implements StoredProcedure {
  ...
  /** default constructor */
  public SalesAmountBySkuGenerateProcedure() {
  }

  public SalesAmountBySkuGenerateProcedure(Date startDate, Date endDate) {
  ...
  public String getProcedureString() {
	  return "{CALL CREATE_SALES_AMOUNT_SKU_PROC(?,?,?)}";
  }
