...
public interface OrderInvoiceDao extends GenericDao<OrderInvoice, Long> {
   ...
   */
  OrderInvoice loadByRowid(Long id);
   ...
   */
  OrderInvoice load(String orderNo);
   ...
   */
  Long insert(OrderInvoice obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(OrderInvoice obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(OrderInvoice obj, LoginInfo loginInfo);
   ...
   */
  List<OrderInvoice> findByQuery(Query query);
   ...
   * @return 検索結果に相当するOrderHeaderのリスト
   */
  List<OrderInvoice> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のOrderHeaderのリスト
   */
  List<OrderInvoice> loadAll();
