 ...
 *
 */
public interface JdShippingRealityDetailDao extends GenericDao<JdShippingRealityDetail, Long> {
   ...
   */
  JdShippingRealityDetail loadByRowid(Long id);
   ...
   */
  JdShippingRealityDetail load(String shippingRealityDetailNo, Long shippingNo);
   ...
   */
  boolean exists(String shippingRealityDetailNo, Long shippingNo);
   ...
   */
  Long insert(JdShippingRealityDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(JdShippingRealityDetail obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(JdShippingRealityDetail obj, LoginInfo loginInfo);
   ...
   * @param TmallShippingDetailNo 出荷明細番号
   */
  void delete(String shippingRealityDetailNo, Long shippingNo);
   ...
   */
  List<JdShippingRealityDetail> findByQuery(Query query);
   ...
   * @return 検索結果に相当するTmallShippingDetailのリスト
   */
  List<JdShippingRealityDetail> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のTmallShippingDetailのリスト
   */
  List<JdShippingRealityDetail> loadAll();
