 ...
 *
 */
public interface IndexBatchCommodityDao extends GenericDao<IndexBatchCommodity, Long> {
   ...
   */
  IndexBatchCommodity loadByRowid(Long id);
   ...
   */
  IndexBatchCommodity load(String commodityCode);
   ...
   */
  Long insert(IndexBatchCommodity obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(IndexBatchCommodity obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(IndexBatchCommodity obj, LoginInfo loginInfo);
   ...
   */
  List<IndexBatchCommodity> findByQuery(Query query);
   ...
   * @return 検索結果に相当するCommodityDetailのリスト
   */
  List<IndexBatchCommodity> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のCommodityDetailのリスト
   */
  List<IndexBatchCommodity> loadAll();
