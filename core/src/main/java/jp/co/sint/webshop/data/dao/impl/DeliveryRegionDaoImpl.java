 ...
 * 
 */
public class DeliveryRegionDaoImpl implements DeliveryRegionDao, Serializable {

	/** Serial Version UID */
	private static final long serialVersionUID = -1;

	/** Generic Dao */
	private GenericDaoImpl<DeliveryRegion, Long> genericDao;
	...
	public DeliveryRegionDaoImpl() {
		genericDao = new GenericDaoImpl<DeliveryRegion, Long>(
	 ...
	 *            删除人信息
	 */
	public void delete(DeliveryRegion obj, LoginInfo loginInfo) {
	 ...
	 * @return 配送会社表信息List
	 */
	public List<DeliveryRegion> findByQuery(Query query) {
	 ...
	 * @return 配送会社信息列表
	 */
	public List<DeliveryRegion> findByQuery(String sqlString, Object... params) {
	 ...
	 */
	public Long insert(DeliveryRegion obj, LoginInfo loginInfo) {
	 ...
	 * @return 全部的配送会社信息列表
	 */
	public List<DeliveryRegion> loadAll() {
...
//	}
	 ...
	 *            更新人信息
	 */
	public void update(DeliveryRegion obj, LoginInfo loginInfo) {
	 ...
	 *            删除的任务信息
	 */
	public void delete(DeliveryRegion transactionObject) {
	 ...
	 * @return 添加成功时返回任务编号
	 */
	public Long insert(DeliveryRegion transactionObject) {
	 ...
	 *            任务信息
	 */
	public void update(DeliveryRegion transactionObject) {
	 ...
	 * @return id对应应配送公司信息
	 */
	public DeliveryRegion loadByRowid(Long id) {
	...
	public boolean exists(String shopCode, String deliveryCompanyNo, String prefectureCode) {
		...
		final String query = "SELECT COUNT(*) FROM DELIVERY_REGION"
	...
	public void deleteAll(String shopCode, String deliveryCompanyNo) {
		Object[] params = new Object[] { shopCode, deliveryCompanyNo };
		final String query = "DELETE FROM DELIVERY_REGION"
