 ...
 *
 */
public interface TmallShippingHeaderDao extends GenericDao<TmallShippingHeader, Long> {
   ...
   */
  TmallShippingHeader loadByRowid(Long id);
   ...
   */
  TmallShippingHeader load(String shippingNo);
   ...
   * @return 主キー列の値に対応するTmallShippingHeaderのインスタンス
   */
  TmallShippingHeader loadByOrderNo(String orderNo);
  /**
   ...
   */
  Long insert(TmallShippingHeader obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void update(TmallShippingHeader obj, LoginInfo loginInfo);
   ...
   * @param loginInfo ログイン情報
   */
  void delete(TmallShippingHeader obj, LoginInfo loginInfo);
   ...
   */
  List<TmallShippingHeader> findByQuery(Query query);
   ...
   * @return 検索結果に相当するTmallShippingHeaderのリスト
   */
  List<TmallShippingHeader> findByQuery(String sqlString, Object... params);

  /**
   * テーブルの全データを一括で取得します。
   * @return テーブルの全データ分のTmallShippingHeaderのリスト
   */
  List<TmallShippingHeader> loadAll();
