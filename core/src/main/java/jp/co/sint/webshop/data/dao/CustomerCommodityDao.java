 ...
 */
public interface CustomerCommodityDao extends GenericDao<CustomerCommodity, Long> {
   ...
   */
  CustomerCommodity loadByRowid(Long id);
   ...
   */
  CustomerCommodity load(String commodityCode,String customerCode);
   ...
   */
  boolean exists(String commodityCode,String customerCode);
   ...
   */
  Long insert(CustomerCommodity obj, LoginInfo loginInfo);
   ...
   *          ログイン情報
   */
  void update(CustomerCommodity obj, LoginInfo loginInfo);
   ...
   *          ログイン情報
   */
  void delete(CustomerCommodity obj, LoginInfo loginInfo);
   ...
   *          ギフトコード
   */
  void delete(String commodityCode,String customerCode);
   ...
   */
  List<CustomerCommodity> findByQuery(Query query);
   ...
   * @return 検索結果に相当するTmallStockAllocationのリスト
   */
  List<CustomerCommodity> findByQuery(String sqlString, Object... params);
   ...
   */
  List<CustomerCommodity> loadAll();
