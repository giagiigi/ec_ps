 ...
 */
public class SalesStarBean extends UISubBean {

  /** serial version uid */
  private static final long serialVersionUID = 1L;

  private List<DetailBean> salesStarList;
  ...
  /**
   * @return the salesStarList
   */
  public List<DetailBean> getSalesStarList() {
    return salesStarList;
  }

  /**
   * @param detailBeanList
   *          the salesStarList to set
   */
  public void setSalesStarList(List<DetailBean> detailBeanList) {
    this.salesStarList = detailBeanList;
  }
