 ...
 */
public class CustomerInitpaymentpasswordUpdateAction extends WebFrontAction<CustomerInitpaymentpasswordBean> {
  ...
  public boolean validate() {
    ...
    CustomerInitpaymentpasswordBean bean = getBean();
  ...
  public WebActionResult callService() {
    ...
    cust.setPaymentPassword(PasswordUtil.getDigest(bean.getNewPassword()));
    cust.setUpdatedDatetime(bean.getUpdatedDatetime());

    ServiceResult sResult = cs.initPaymentPassword(cust, bean.getToken());
