 ...
 */
public class GiftCardActivateAction extends WebFrontAction<GiftCardBean> {
  ...
  public WebActionResult callService() {
    ...
    GiftCardIssueDetail cardDetail = service.getGiftCardIssueDetailByPassWord(bean.getPassWord());
    if (cardDetail == null ) {
