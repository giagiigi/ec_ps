 ...
 * @author kousen
 */
public class FeaturedDetailBean extends UIFrontBean {
  ...
  private List<FeaturedDetailCommodityBean> list = new ArrayList<FeaturedDetailCommodityBean>();
  ...
  public static class FeaturedDetailCommodityBean implements Serializable {
  ...
  public String getModuleName() {
    return Messages.getString("web.bean.front.catalog.FeaturedDetailBean.0");
   ...
   * @return the list
   */
  public List<FeaturedDetailCommodityBean> getList() {
    return list;
  }
   ...
   *          the list to set
   */
  public void setList(List<FeaturedDetailCommodityBean> list) {
    this.list = list;
  }
  ...
  public List<CodeAttribute> getPageTopicPath() {
    ...
    topicPath.add(new NameValue(this.planName, "/featured"));
