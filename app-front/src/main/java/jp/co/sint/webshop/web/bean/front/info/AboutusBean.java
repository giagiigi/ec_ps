 ...
 */
public class AboutusBean extends UIFrontBean {
  ...
  public String getModuleName() {
    return Messages.getString("web.bean.front.info.AboutusBean.0");
  }
  ...
  public List<CodeAttribute> getPageTopicPath() {
    ...
    topicPath.add(new NameValue(Messages.getString("web.bean.front.info.AboutusBean.1"), "/siteinfo/aboutus"));
