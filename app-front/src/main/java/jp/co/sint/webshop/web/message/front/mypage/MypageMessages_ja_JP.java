 ...
 */
public class MypageMessages_ja_JP extends ListResourceBundle {
  ...
  protected Object[][] getContents() {
    Object[][] obj = {
        ...
        ,
        {
            "customer_group_upgrades_remind_one", "あと{0}元以上のご利用で{1}月から{2}です！"
        },
        {
            "customer_group_upgrades_remind_two", "おめでとうございます，{0}月から{1}になります！ あと{2}元のご利用で{3}です！"
        },
        {
            "customer_group_upgrades_remind_three", "おめでとうございます，{0}月から{1}になります！"
        },
        {/**2013/04/01 优惠券对应 ob add start*/
          "search_result_overflow", "検索可能上限数を超えたため検索結果{0}件中、先頭の{1}件を表示します。"
        },
        {
          "coupon_exchange_success", "チャージ成功"
        },
        {
          "not_frient_use_coupon","お友達よりクーポンを利用されたことがありません。"
        },
        {
          "coupon_exchange_unsuccess", "クーポン交換失敗" 
        }
