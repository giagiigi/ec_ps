...
import jp.co.sint.webshop.web.bean.front.catalog.DetailRecommendBBean;
 ...
 */
public class DetailRecommendBSubAction extends DetailRecommendBaseAction {
  ...
  public void callService() {
    ...
    if(sesContainer.getSession() != null){
      logger.info("当前DetailRecommendBSubAction:sessionID="+sesContainer.getSession().getId()+"开始记录--------------------------------------------------------------------");
    }else{
      logger.info("当前DetailRecommendBSubAction:session缺失，开始记录--------------------------------------------------------------------");
    }
    ...
    DetailRecommendBBean reqBean = new DetailRecommendBBean();
    ...
    if(sesContainer.getSession() != null){
      logger.info("当前DetailRecommendBSubAction:sessionID="+sesContainer.getSession().getId()+"结束记录--------------------------------------------------------------------");
    }else{
      logger.info("当前DetailRecommendBSubAction:session缺失，结束记录--------------------------------------------------------------------");
    }
  }
